...
void compare_pid_v2()
{
    ...
    TFile *file_output = TFile::Open("compare_pid_v2_12_4.root", "RECREATE");
    ...
    leg->AddEntry(ratio_pi, "Ratio Pi", "l");
    leg->AddEntry(pure_pi, "Pure Pi", "l");
    leg->Draw("SAME");
    ...
    leg2->AddEntry(ratio_ka, "Ratio Ka", "l");
    leg2->AddEntry(pure_ka, "Pure Ka", "l");
    leg2->Draw("SAME");
    ...
    leg3->AddEntry(ratio_pr, "Ratio Pr", "l");
    leg3->AddEntry(pure_pr, "Pure Pr", "l");
    leg3->Draw("SAME");
